  ...
  return (
    <section id="activism" className="py-24 bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 md:p-12 shadow-2xl cursor-pointer hover:border-gray-700 transition-colors"
          onClick={() => sendMetaEvent('Lead')}
        >
